            ...
            <el-form ref="form" :model="form" :rules="rules" label-width="125px" label-position="right" style="padding:0 30px;">
                ...
                <el-form-item label="合同附件：">
                    <el-upload ref="upload"
                        accept='xlapplication/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheets'
                        :action="url"
    ...
    export default{
        ...
        data(){
            return {
                ...
                url: appHost + appRoot + '/ctm/contract/files/upload',  //合同文件上传路径
                rules: {
                    salesmanName: [{
                         required: true,
                         message: '合同发起人不能为空！'
                ...
                this.ajax({  //获取个人信息
                    ...
                    success(data, $this) {
                        if (data.code == 'success') {
                            ...
                            $this.form.department = (data.content.depName).split('-').reverse().join('-');
                        }
                    }
                });
            },
