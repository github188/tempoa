			...
			<div class="content-box">
				<div class="content-l">
					...
					<div class="person-info box">
						...
						<p class="person-pos" ref="post">{{personInfo.depName | getDepart}}<span ref="depart">{{personInfo.post}}</span></p>
					</div>
								...
								<router-link target="_blank" :to="'/news/detail/?id=' + stickNews.id">
									...
									<div class="top-line">
										<h2 class="top-line-title" id="topPublic">
											...
											<router-link target="_blank" :to="'/news/detail/?id=' + stickNews.id">{{stickNews.newsTitle}}</router-link>								
