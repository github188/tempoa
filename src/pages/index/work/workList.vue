		...
		<div class="work-order">
		    ...
		    <el-tabs v-model="activeTab" @tab-click="queryList" class="work-list-tab" type="card">
                <el-tab-pane name="todo">
					<span slot="label"><i class="icon icon-todo"></i> 我的待办</span>
				        				...
				        				<p class="padding-b-10">{{item.title}}</p>
										  ...
										  <el-col :span="8" style="text-align: center">
										  		<span v-if="item.doingPerson.length">
										  			{{item.donePerson | dealStatus(item.doingPerson)}}&nbsp;&nbsp; <span class="deal-status">处理中</span>	
										  		</span>
										  		<span v-else>
                ...
                <el-tab-pane name="done">
                	<span slot="label"><i class="icon icon-done"></i> 我的已办</span>
...
<style>
	...
	.work-order .el-autocomplete-suggestion__wrap, .work-order .el-pager li, .work-order .el-pagination .btn-next, .el-pagination .btn-prev, .work-order .el-pager li:last-child{
		border: none;	
	}
					...
					success(data, $this){
						if(data.code == 'success'){
							if(name == 'todo'){
								...
								console.log(data.content, 123123)
							}else if(name == 'done'){
